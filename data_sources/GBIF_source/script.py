...
#change the name of the species and the csv file from which you are extracting
search_name = "Lactarius deliciosus"
multi_file = "multimedia_LD.csv"
...
data_file = os.path.join(here, multi_file)

df = pd.read_csv(data_file, delimiter=';')

my_list = df.identifier.tolist()
print(len(my_list))
